# ADK Research Agent Best Experiment #140
# Score: avg=91.559, improvement=+0.065
# Timestamp: 2026-03-20T17:23:34.279378+00:00
...
def experimental_pred_fn(state: dict, global_mult, fk_buckets) -> np.ndarray:
    ...
    # Regime-Adaptive Distance Blending
    # Thriving: Expansion everywhere. Standard baseline weights are mathematically optimal.
    # Collapse/Moderate: Expansion only near settlements. Suppress empirical noise far away.
    if is_thriving:
    ...
    # Empirical Bypass for False Spikes in Delayed Collapse
