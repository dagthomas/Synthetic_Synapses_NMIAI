# ADK Research Agent Best Experiment #28
# Score: avg=88.074, improvement=+0.172
# Timestamp: 2026-03-20T18:29:33.975345+00:00
...
def experimental_pred_fn(state: dict, global_mult, fk_buckets) -> np.ndarray:
    ...
    # 2. Universal Density-Aware Adjustment
    ...
    # Apply the density penalty to BOTH existing settlements (survival) AND adjacent plains (expansion)
