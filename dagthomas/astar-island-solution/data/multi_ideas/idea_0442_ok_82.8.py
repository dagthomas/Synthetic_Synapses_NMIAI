# Score: avg=82.84
# Direction: Increase the global prior multiplier for the `port` class from 1.0 to 1.12 to compensate for the und
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    nonzero_mask = pred > 1e-6
    pred = np.where(nonzero_mask, np.maximum(pred, 0.005), pred)
