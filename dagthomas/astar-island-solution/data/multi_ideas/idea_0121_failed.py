...
# Direction: Increase the `port` class global multiplier from 1.0 to 1.04 to address the coastal cell underpredic
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Apply global multipliers and ratio
    pred *= ratio
    ...
    pred[valid_mask] = np.maximum(pred[valid_mask], 0.005)

    # Re-apply constraints after floor
    return probs