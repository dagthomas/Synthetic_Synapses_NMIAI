# FAILED: Compilation failed: invalid syntax (<string>, line 40)
# Direction: Increase the `port` class global multiplier from 1.0 to 1.08 to mitigate coastal underprediction. Th
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Ratio
    if global_mult is not None and hasattr(global_mult, 'observed') and
    return probs