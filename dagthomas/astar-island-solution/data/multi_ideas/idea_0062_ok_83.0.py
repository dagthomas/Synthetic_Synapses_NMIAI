# Score: avg=83.02
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.05 to address coastal underpredict
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Increase global multiplier for port (class 2) to 1.05
    ratio[2] *= 1.05
