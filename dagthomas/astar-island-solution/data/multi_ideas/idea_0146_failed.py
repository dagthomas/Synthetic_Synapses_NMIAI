...
# Direction: Increase the settlement class upper clamp from 2.5 to 3.2. This should reduce the dominant KL diverg
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 2.
    return probs