# Score: avg=81.85
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.1 to address the reported coastal 
# Error: None
...
def experimental_pred_fn(state: dict, global_mult,
    ...
    # Increase the global multiplier for the port class
    ratio[2] *= 1.1
