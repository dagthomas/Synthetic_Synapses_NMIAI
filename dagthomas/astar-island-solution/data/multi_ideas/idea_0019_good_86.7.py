# Score: avg=86.68
# Direction: **Increase the settlement clamp upper bound by 0.2** (e.g., 2.5 → 2.7) — tightening failed with 
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    for i in range(N):
        ...
        mults[1] = np.clip(mults[1], 0.08, 2.2)
    ...
    forest_near = 0.83 + 0.02 * regime
    gamma_forest = gamma * 0.85
