# Score: avg=83.04
# Direction: Increase the `coarse_max` calibration weight from its current value to 12.0 to further capitalize on
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 12.0,
