# FAILED: Compilation failed: invalid syntax (<string>, line 39)
# Direction: Change the FK blend normalization from `(pw + ew)` to `max(pw, ew)` to prevent the dilution of stron
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    p = {"prior_w": 2.0, "emp_max": 10.0, "ratio_power": 1.0}
