# Score: avg=82.60
# Direction: Increase the `port` class `clamp_max` from 2.0 to 2.3 to address coastal underprediction.
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Clamp maxes - Port class (2) clamp_max increased to 2.3
    c_maxes = np.array([3.0, 3.0, 2.3, 3.0, 3.0, 3.0])
    pred = np.minimum(pred, c_maxes)
