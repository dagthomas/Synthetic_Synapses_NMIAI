...
# Direction: Increase the `coarse_max` calibration weight from 3.1 to 3.6 to better anchor the settlement class p
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 3.6,
