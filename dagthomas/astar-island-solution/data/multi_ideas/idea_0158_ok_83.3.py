# Score: avg=83.32
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 3.2 to more aggressively
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 3.2,
    ...
    # 7. Mountain and Coast constraints
    is_mountain = (grid == 3)
