# Score: avg=82.94
# Direction: Increase the `port` class `global_calibration` from 1.1 to 1.25 to address the underprediction on co
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # 5. Global Multipliers and Calibration
    pred *= ratio
    global_calibration = np.array([1.0, 1.0, 1.25, 1.0, 1.0, 1.0])
    pred *= global_calibration

    # 6. Constraints and Normalization
    ...
    probs = pred / np.maximum(sums, 1e-10)
