# FAILED: Crashed on round2 seed 0: name 'build' is not defined
# Direction: Increase the `settlement` class `clamp_range` upper bound from 2.5 to 2.75 to better capture high-de
