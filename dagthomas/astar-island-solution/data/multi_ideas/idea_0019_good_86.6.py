# Score: avg=86.61
# Direction: Increase the settlement class global multiplier from 1.0 to 1.05 to reduce the KL divergence error i
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[1] = np.power(ratio[1], bp) * 1.05
    ...
    if is_sett.any():
        ...
        dist_map = np.ones((MAP_H, MAP_W)) * 100

    if obs_expansion_radius is not None:
        pred[dist_map > obs_expansion_radius, 1] *= 0.1
