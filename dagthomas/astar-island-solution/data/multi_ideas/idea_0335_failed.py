# FAILED: Crashed on round2 seed 0: cannot unpack non-iterable function object
# Direction: Increase the `settlement` class `clamp_range` upper limit from 2.5 to 2.7 to allow for higher confid
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = predict._load_params() if hasattr(predict, '_load_params') else {"prior_w": 1.0, "emp_max": 2.0}
