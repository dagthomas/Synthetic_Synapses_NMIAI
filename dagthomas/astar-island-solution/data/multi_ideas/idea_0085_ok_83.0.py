# Score: avg=83.01
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.12 to specifically address underpr
# Error: None
...
def experimental_pred_fn(state: dict, global_mult,
    ...
    coastal = _build_coastal_mask(grid).astype(int)
    mountain = (grid == 3).astype(int)
