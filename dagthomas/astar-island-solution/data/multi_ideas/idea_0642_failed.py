# FAILED: Compilation failed: invalid syntax (<string>, line 52)
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.15. This provides a mo
