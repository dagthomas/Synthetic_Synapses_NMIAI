# Score: avg=83.37
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 3.0 to allow higher peak probability densiti
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_max = np.full(NUM_CLASSES, 2.5)
    clamp_max[1] = 3.0  # Settlement clamp max increased to 3.0
