# Score: avg=82.67
# Direction: Increase the `port` class `global_calibration` multiplier from 1.0 to 1.1 to address the coastal und
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    global_calibration[2] = 1.1
    ratio = ratio * global_calibration
