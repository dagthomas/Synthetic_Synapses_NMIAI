# FAILED: Compilation failed: '(' was never closed (<string>, line 48)
# Direction: Increase the `port` class `global_calibr` multiplier from 1.0 to 1.08 to address the coastal underpr
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    _load_params = getattr(predict, '_load_params', lambda: {"prior_w": 1.0, "emp_max": 3.0})
    p = _load_params()
