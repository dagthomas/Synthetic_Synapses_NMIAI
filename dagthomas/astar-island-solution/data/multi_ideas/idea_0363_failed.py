# FAILED: Crashed on round2 seed 0: name 'exp' is not defined
# Direction: Increase the `settlement` class `clamp_range` upper bound from 2.5 to 2.75 to allow for higher peak 
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    p = {"prior_w": 1.0, "emp_max": 3.0, "spatial_w": 0.5}
