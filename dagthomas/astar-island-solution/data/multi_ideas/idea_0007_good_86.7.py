# Score: avg=86.65
# Direction: **Try reducing the settlement class prior multiplier by 10% (e.g., if currently 2.0, set to 1.8)** â
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    # Settlement prior boost reduced by 10%: was 1.30+0.17*x, now 1.17+0.153*x
    sett_prior_boost = 1.17 + 0.153 * (regime_raw - 0.3) / 1.2
