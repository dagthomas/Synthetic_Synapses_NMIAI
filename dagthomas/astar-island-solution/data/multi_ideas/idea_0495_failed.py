...
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 3.2 to allow the Bayesian update to better f
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = {"prior_w": 1.0, "emp_max": 2.0, "smooth_size": 3, "growth_w": 0.5}
