...
# Direction: Adjust the `settlement` class clamp range from [0.15, 2.5] to [0.10, 3.0] to allow the Bayesian upda
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = {"prior_w": 2.0, "emp_max": 10.0, "smooth_size": 3, "smooth_w": 0.1, "floor": 0.005}
