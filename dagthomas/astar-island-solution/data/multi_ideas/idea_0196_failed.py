...
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.35 to better leverage 
...
def experimental_pred_fn(state: dict, global_mult,
    ...
    cal_coarse_max_arr = np.full(NUM_CLASSES, 2.0)
    cal_coarse_max_arr[3] = 2.35  # Increased settlement
    return probs