# Score: avg=86.67
# Direction: **Increase the forest class prior multiplier by 1% (e.g., 1.0 → 1.01)** to help the empty/forest r
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    for i in range(N):
        ...
        mults[2] = np.clip(mults[2], 0.08, 2.5)
        mults[3] = np.clip(mults[3], 0.08, 2.5)
