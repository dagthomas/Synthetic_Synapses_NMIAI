# Score: avg=86.60
# Direction: Increase the port class global multiplier by 12% (e.g., from 1.0 to 1.12) to specifically address th
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = {"prior_w": 1.5, "emp_max": 2.0, "base_power": 0.5}
    ...
    # Apply 12% lift to port class multiplier
    mult[2] *= 1.12
    ...
    if is_sett.any():
        ...
        if obs_expansion_radius is not None:
            outside = dist_map > obs_expansion_radius
            pred[outside, 1:] = 0.0
            pred[outside, 0] = 1.0
