# Score: avg=85.49
# Direction: Adjust the settlement class upper clamp limit from 2.5 to 2.75 to better capture high-density settle
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = {"prior_w": 2.0, "emp_max": 3.0, "base_power": 0.8}
