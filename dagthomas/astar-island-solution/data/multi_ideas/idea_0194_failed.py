# FAILED: Compilation failed: '(' was never closed (<string>, line 29)
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.4. This targets the do
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    if est_vigor is not None:
        cal = predict.get_regime_calibration(est
    return probs