# Score: avg=82.13
# Direction: Increase the `port` class `global_calibration` factor from 1.0 to 1.12 to address coastal underpredi
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Increase the port class global_calibration factor from 1.0 to 1.12
    ratio[2] *= 1.12
    ...
    # Apply floor and re-apply constraints
