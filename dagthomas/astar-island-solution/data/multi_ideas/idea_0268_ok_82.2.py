# Score: avg=82.24
# Direction: Adjust the `settlement` class `global_multiplier` from 1.0 to 0.94 to reduce the dominant KL diverge
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    class_mult = np.ones(NUM_CLASSES)
    class_mult[1] = 0.94
    pred *= class_mult
    ...
    nz = pred > 0
    pred[nz] = np.maximum(pred[nz], 0.005)
