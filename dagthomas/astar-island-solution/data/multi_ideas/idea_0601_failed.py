# FAILED: Compilation failed: '[' was never closed (<string>, line 58)
# Direction: Increase the `port` class `global_calibration` multiplier from 1.0 to 1.15 to address the underpredi
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    p = {"prior_w": 1.0, "emp_max": 2.0, "ratio_power": 0.5, "smooth_w": 0.1}
    ...
    blended = pred * prior_w + emp_grid * strengths[:, :, np.neww
    return probs