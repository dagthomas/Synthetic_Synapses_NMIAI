# FAILED: Compilation failed: invalid syntax (<string>, line 81)
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.3 to sharpen the proba
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    if growth_front_map is not None:
        pred[:, :, 1] *= np.maximum(growth_front_map, 1e-2)
