...
# Direction: Increase the `port` class `global_calibration` multiplier from 1.0 to 1.08 to address the coastal un
...
def experimental_pred_fn(state: dict, global_mult: 'GlobalMultipliers',
    ...
    # Apply global multiplier ratio
    pred *= ratio
    
    # MODIFICATION: Increase the port class global_calibration multiplier from 1.0 to 1.08
    pred[:, :, 2] *= 1.08

    # Blend with simulation prediction if provided
