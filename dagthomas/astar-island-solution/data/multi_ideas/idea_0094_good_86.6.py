# Score: avg=86.56
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.18 to address the coastal underpre
# Error: None
...
def experimental_pred_fn(state: dict, global_mult,
    ...
    if is_sett.any() and obs_expansion_radius is not None:
        ...
        pred[dist_map > obs_expansion_radius, 1:5] = 0.0
