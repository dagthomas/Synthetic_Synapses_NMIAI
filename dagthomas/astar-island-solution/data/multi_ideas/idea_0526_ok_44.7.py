# Score: avg=44.69
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 3.2 to allow the Bayesian update to more str
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_max = np.array([1.5, 3.2, 2.0, 2.0, 1.5, 1.1])
    pred = np.clip(pred * ratio, 0, clamp_max)
