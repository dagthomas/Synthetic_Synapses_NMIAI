# FAILED: Compilation failed: '(' was never closed (<string>, line 87)
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 2.8 to better capture high-density settlemen
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # 5. Ratio application with updated clamp_max for settlement class (index 3)
    clamp_max = np.array([2.5, 2.5, 2.5, 2.8, 2.5, 2.5])
    ratio_clipped = np.clip(ratio, 0.1, clamp_max)
    pred = pred * ratio_clipped
