...
# Direction: Adjust the settlement class upper clamp from 2.5 to 2.0 to mitigate the dominant KL divergence error
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = {"prior_w": 1.0, "emp_max": 2.0, "base_power": 0.5, "smooth_w": 0.1}
