# Score: avg=86.69
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.12 to address coastal cell underpr
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[2] = np.clip(mult[2], 0.15, 2.0) * 1.12
