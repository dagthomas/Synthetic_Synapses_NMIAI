# FAILED: Crashed on round2 seed 0: name 'ratio_clamped' is not defined
# Direction: Adjust the `settlement` class `clamp_range` from [0.15, 2.5] to [0.12, 2.7] to allow for higher peak
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_min = np.full(NUM_CLASSES, 0.2)
    clamp_min[1] = 0.12
