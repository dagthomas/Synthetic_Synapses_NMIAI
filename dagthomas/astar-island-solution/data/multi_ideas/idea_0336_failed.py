# FAILED: Crashed on round2 seed 0: cannot unpack non-iterable NoneType object
# Direction: Increase the `coarse_max` calibration weight from 3.0 to 4.0 to better utilize high-confidence bucke
