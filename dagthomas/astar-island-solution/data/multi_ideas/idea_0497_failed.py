# FAILED: Compilation failed: invalid syntax (<string>, line 54)
# Direction: Increase the `port` class `clamp_max` from 2.0 to 2.5 to mitigate the underprediction of ports in co
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_max = np.array([2.0, 2.0, 2.5, 2.0, 2.0, 2.0])
