# FAILED: Compilation failed: invalid syntax (<string>, line 33)
# Direction: Adjust the `settlement` class upper probability clamp from 2.5 down to 2.25 to reduce over-calibrati
