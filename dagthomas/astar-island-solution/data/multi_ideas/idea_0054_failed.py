# FAILED: Compilation failed: '[' was never closed (<string>, line 60)
# Direction: Increase the `settlement` class calibration weight `coarse_max` from 2.0 to 2.4 to better regularize
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    blended = pred * prior_w + emp_grid * strengths[:, :, np
    return probs