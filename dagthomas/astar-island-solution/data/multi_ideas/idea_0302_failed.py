...
# Direction: Adjust the `settlement` class `clamp_range` from [0.15, 2.5] to [0.10, 3.0] to better capture high-d
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Clamp ranges - Modified settlement (class 1) to [0.10, 3.0]
    clamp_min = np.array([0.5, 0.10, 0.5, 0.5, 0.5, 0.5])
    clamp_max = np.array([2.0, 3.0, 2.0, 2.0, 2.0, 2.0])
    ratio = np.clip(ratio, clamp_min, clamp_max)
