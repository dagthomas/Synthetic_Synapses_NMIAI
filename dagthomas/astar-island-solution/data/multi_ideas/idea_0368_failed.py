# FAILED: Compilation failed: unterminated string literal (detected at line 36) (<string>, line 36)
# Direction: Increase the `coarse_max` calibration weight from 44.6 to 52.0 to further stabilize the high-level d
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_
    return probs