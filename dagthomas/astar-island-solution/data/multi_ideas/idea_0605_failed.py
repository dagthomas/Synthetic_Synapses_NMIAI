...
# Direction: Increase the `settlement` class `clamp_max` parameter from 2.5 to 2.65 to allow for slightly more co
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        'cal_fine_base': 1.0, 'cal_fine_divisor': 100.0, 'cal__
    return probs