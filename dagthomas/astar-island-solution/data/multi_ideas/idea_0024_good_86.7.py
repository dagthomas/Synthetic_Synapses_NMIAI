# Score: avg=86.68
# Direction: Reduce the settlement class prior multiplier by 5–10% (e.g., from 1.5 → 1.35); settlement domina
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    sett_prior_boost = 1.20 + 0.15 * (regime_raw - 0.3) / 1.2
