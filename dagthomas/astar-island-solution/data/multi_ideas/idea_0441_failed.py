# FAILED: Compilation failed: '(' was never closed (<string>, line 89)
# Direction: Increase the global prior multiplier for the `port` class from 1.0 to 1.18 to address coastal underp
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # MODIFICATION: Increase global prior multiplier for port class (2) to 1.18
    pred[:, :, 2] *= 1.18
