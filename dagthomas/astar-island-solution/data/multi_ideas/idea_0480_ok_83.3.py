# Score: avg=83.29
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 2.8 to allow the Bayesian update to reach hi
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # 5. Apply Ratio and Clamp Maximums
    pred *= ratio
    # Clamp max increased to 2.8 for settlement (index 1)
    clamp_max = np.array([2.5, 2.8, 2.5, 2.5, 2.5, 2.5])
    pred = np.minimum(pred, clamp_max)

    # 6. Topographical Rules and Minimum Floor
