# Score: avg=82.87
# Direction: Increase the `port` class `global_multiplier` to 1.20 to directly address the underprediction on coa
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # MODIFICATION: Increase port global multiplier to 1.20
    ratio[2] = max(ratio[2], 1.20)
    ...
    # Mix with sim_pred if available
