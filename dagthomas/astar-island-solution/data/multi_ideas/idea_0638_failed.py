# FAILED: Compilation failed: invalid syntax (<string>, line 64)
# Direction: Increase the settlement class `coarse_max` calibration weight from 2.0 to 2.1 to slightly increase t
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 2.1,
