# Score: avg=82.37
# Direction: Increase the `settlement` class `global_calibration` multiplier from 1.0 to 1.15. This should help c
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    global_cal = np.ones(NUM_CLASSES)
    global_cal[1] = 1.15
    pred *= global_cal
    ...
    probs = np.zeros((MAP_H, MAP_W, NUM_CLASSES))
