# Score: avg=82.19
# Direction: Increase the global prior multiplier for the `port` class by 0.08 to address coastal underprediction
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    def get_tc(t):
        if isinstance(terrain_to_class, dict):
            return terrain_to_class.get(t, 0)
        return 0
    terrain_classes = np.vectorize(get_tc)(grid)
    pred[terrain_classes != 5, 5] = 0.0
