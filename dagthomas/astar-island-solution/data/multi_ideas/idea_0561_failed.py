# FAILED: Compilation failed: '(' was never closed (<string>, line 72)
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 2.72 to reduce the KL penalty on high-probab
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_max = np.array([2.5, 2.5, 2.5, 2.72, 2.5, 2.5])
    ratio = np.clip(ratio, 0.5, clamp_max)
