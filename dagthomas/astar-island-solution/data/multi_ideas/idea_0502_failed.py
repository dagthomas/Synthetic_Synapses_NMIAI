# FAILED: Compilation failed: '(' was never closed (<string>, line 59)
# Direction: Increase the `settlement` class `clamp_max` parameter from 2.5 to 3.0 to allow for higher peak proba
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    blended /= np.maximum(blended.sum
    return probs