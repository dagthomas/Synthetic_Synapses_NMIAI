...
# Direction: Adjust the `settlement` class clamp range upper bound from 2.5 to 2.2 to reduce high-entropy penalti
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    if hasattr(predict, '_load_params'):
        ...
        p = {"prior_w": 1.5, "emp_max": 2.0, "growth_front_mult": 0.5}
