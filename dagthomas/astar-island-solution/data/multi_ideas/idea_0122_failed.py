...
# Direction: Increase the smoothing kernel size from 3 to 5 to better regularize the empty-to-forest transition r
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    try:
        ...
        p = {"prior_w": 0.5, "emp_max": 2.0, "base_power": 1.0}
