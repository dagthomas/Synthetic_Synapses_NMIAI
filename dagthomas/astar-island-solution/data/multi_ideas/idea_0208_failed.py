...
# Direction: Increase the `settlement` class clamp range upper bound from 2.5 to 3.2 to allow for stronger activa
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = predict._load_params() if hasattr(predict, '_load_params') else {"prior_w": 2.0, "emp_max": 5.0}
