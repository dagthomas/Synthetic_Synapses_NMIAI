# FAILED: Compilation failed: invalid syntax (<string>, line 66)
# Direction: Increase the `coarse_max` calibration weight for the `settlement` class from 2.0 to 2.5. This should
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_max': np.array([2.0, 2.5, 2.0, 2.0, 2.0, 2.0]),
