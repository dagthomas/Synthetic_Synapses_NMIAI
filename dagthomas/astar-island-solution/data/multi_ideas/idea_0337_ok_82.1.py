# Score: avg=82.12
# Direction: Adjust the `settlement` class `clamp_range` from [0.15, 2.5] to [0.14, 2.8] to allow higher probabil
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_min = np.array([0.15, 0.14, 0.15, 0.15, 0.15, 0.15])
