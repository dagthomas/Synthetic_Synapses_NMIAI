...
# Direction: Increase the `settlement` class `clamp_max` value from 2.5 to 2.8 to reduce the over-suppression of 
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = globals().get('_load_params', lambda: {"prior_w": 1.0, "emp_max": 1.0})()
