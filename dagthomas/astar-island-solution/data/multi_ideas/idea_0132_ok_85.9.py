# Score: avg=85.88
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.1 to address coastal underpredicti
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    probs = np.where(pred > 0, np.maximum(pred, 0.005), 0.0)
