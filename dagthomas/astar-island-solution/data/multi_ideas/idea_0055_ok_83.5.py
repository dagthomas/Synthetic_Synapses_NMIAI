# Score: avg=83.46
# Direction: Decrease the `forest` class global multiplier from 1.0 to 0.97 to improve the predicted forest-to-em
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    probs /= np.maximum(row_sums, 1e-10)

    zero_mask = (row_sums.reshape(40, 40) == 0)
    probs[zero_mask, 0] = 1.0
    probs[zero_mask, 1:] = 0.0
