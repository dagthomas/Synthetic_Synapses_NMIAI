# FAILED: Crashed on round2 seed 0: name '_build_feature_key' is not defined
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.25 to address the domi
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    idx_grid, unique_keys = _build_feature_key
    return probs