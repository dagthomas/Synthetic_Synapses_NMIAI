# FAILED: Compilation failed: expected ':' (<string>, line 87)
# Direction: Increase the `settlement` class clamp range upper bound from 2.5 to 3.5 to reduce the dominant KL di
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    ratio_upper = np.full(NUM_CLASSES, 2.5)
    ratio_upper[1] = 3.5
    ratio = np.clip(ratio, 0.1, ratio_upper)
