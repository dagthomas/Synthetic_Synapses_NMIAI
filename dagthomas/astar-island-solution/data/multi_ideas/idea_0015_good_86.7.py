# Score: avg=86.68
# Direction: Reduce the empty class prior multiplier by 10% (e.g., 1.0 â†’ 0.9) to suppress over-prediction of em
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    empty_mult *= 0.9  # 10% reduction to suppress empty over-prediction near settlements
