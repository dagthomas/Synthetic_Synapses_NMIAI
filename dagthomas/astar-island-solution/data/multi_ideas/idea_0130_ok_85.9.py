# Score: avg=85.88
# Direction: Decrease the settlement class upper clamp from 2.5 to 2.2 to reduce over-prediction variance in the 
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[1] = np.clip(mult[1], 0.15, 2.2)
    ...
    if is_sett.any():
        ...
        if obs_expansion_radius is not None:
            ...
            pred[out_of_bounds, 2] *= 0.1
            pred[out_of_bounds, 3] *= 0.1
