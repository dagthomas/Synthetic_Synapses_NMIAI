...
# Direction: Adjust the `settlement` class `coarse_max` calibration weight from 2.0 to 2.25 to increase the influ
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        'cal_fine_base': 1.0, 'cal_fine_divisor': 100.0, 'cal
    return probs