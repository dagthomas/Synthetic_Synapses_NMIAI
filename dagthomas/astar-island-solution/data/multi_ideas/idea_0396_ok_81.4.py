# Score: avg=81.43
# Direction: Adjust the `settlement` class `clamp_range` from [0.15, 2.5] to [0.10, 2.8] to allow the Bayesian up
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_min = np.full(NUM_CLASSES, 0.1)
    clamp_max = np.full(NUM_CLASSES, 5.0)
    clamp_min[3] = 0.10
    clamp_max[3] = 2.8
