# FAILED: Compilation failed: invalid syntax (<string>, line 42)
# Direction: Increase the `coarse_max` calibration weight from 1.0 to 1.1 to better stabilize the Bayesian update
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 1.1,
