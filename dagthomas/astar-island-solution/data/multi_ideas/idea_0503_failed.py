# FAILED: Compilation failed: '(' was never closed (<string>, line 74)
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 3.0 to allow for higher peak density and red
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    blended /= np.maximum(blended.sum(axis
    return probs