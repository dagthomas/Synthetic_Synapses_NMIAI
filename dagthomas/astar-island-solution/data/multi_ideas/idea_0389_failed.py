# FAILED: Compilation failed: '[' was never closed (<string>, line 90)
# Direction: Increase the `coarse_max` calibration weight from 2.0 to 2.6 to better regularize the settlement pre
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 2.6,
