...
# Direction: Adjust the settlement class clamp range from [0.15, 2.5] to [0.12, 2.4] to reduce the entropy-weight
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[1] = np.clip(mult[1], 0.12, 2.4)
    mult[2] = np.clip(mult[2], 0.12, 2.4)
    mult[3] = np.clip(mult[3], 0.12, 2.4)
