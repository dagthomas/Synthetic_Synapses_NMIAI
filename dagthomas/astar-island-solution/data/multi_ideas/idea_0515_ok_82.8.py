# Score: avg=82.81
# Direction: Increase the `port` class global calibration weight from 1.0 to 1.15 to address the coastal underpre
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    for i in range(NUM_CLASSES):
        mask = pred[:, :, i] > 0
        pred[mask, i] = np.maximum(pred[mask, i], 0.005)
