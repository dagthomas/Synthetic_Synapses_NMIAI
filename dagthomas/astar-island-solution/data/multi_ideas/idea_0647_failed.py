# FAILED: Crashed on round2 seed 0: module 'predict' has no attribute 'get_'
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.6 to more aggressively
