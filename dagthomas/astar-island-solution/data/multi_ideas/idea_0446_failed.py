...
# Direction: Adjust the `settlement` class `clamp_range` from [0.15, 2.5] to [0.12, 2.7] to allow empirical data 
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Clamp ratio with adjusted settlement range [0.12, 2.7]
    clamp_min = np.full(NUM_CLASSES, 0.5)
