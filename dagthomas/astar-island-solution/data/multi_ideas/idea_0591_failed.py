# FAILED: Crashed on round2 seed 0: name 'clamp_max' is not defined
# Direction: Adjust the `settlement` class `clamp_max` parameter from 2.5 to 2.75 to reduce peak-probability clip
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # 5. Apply Global Multipliers with modified clamp_max
    clamp_max
    return probs