# Score: avg=84.77
# Direction: Adjust the `settlement` class `clamp_max` from 2.5 to 2.75 to reduce probability clipping in high-de
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_maxes = np.array([5.0, 2.75, 5.0, 5.0, 5.0, 5.0])
    pred = np.minimum(pred, raw_priors[idx_grid] * clamp_maxes)
