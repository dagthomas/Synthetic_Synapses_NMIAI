# Score: avg=83.50
# Direction: Adjust the `settlement` class `clamp_range` from [0.15, 2.5] to [0.12, 2.8] to allow the Bayesian up
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    if obs_expansion_radius is not None and settlements:
        ...
        far_mask = dist > obs_expansion_radius
        pred[far_mask, 1] *= 0.1
