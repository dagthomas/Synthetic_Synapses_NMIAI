# Score: avg=86.21
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.3 to address the coastal underpred
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[2] = np.clip(mult[2], 0.15, 2.0) * 1.3
    ...
    pred = np.where(valid_mask, np.maximum(pred, 0.005), 0.0)
