# FAILED: Crashed on round2 seed 0: name 'clamp_' is not defined
# Direction: Increase the `settlement` class `clamp_range` upper bound from 2.5 to 2.7 to better accommodate high
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # 5. Ratio adjustment with clamped bounds
    clamp_
    return probs