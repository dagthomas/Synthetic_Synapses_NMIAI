# FAILED: Compilation failed: invalid syntax (<string>, line 32)
# Direction: Adjust the settlement class `clamp_range` from [0.15, 2.5] to [0.18, 2.3] to reduce entropy-weighted
