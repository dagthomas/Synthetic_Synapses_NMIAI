# Score: avg=86.60
# Direction: Increase the **forest class prior multiplier** very slightly (e.g., 1.0 → 1.08) to reduce empty/fo
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    for i in range(N):
        ...
        # Forest prior boost: reduce empty/forest misclassification near settlements
        prior[4] *= 1.08
        prior = prior / prior.sum()
        ...
        mults[1] = np.clip(mults[1], 0.06, 2.5)
