# Score: avg=83.17
# Direction: Increase the `settlement` class `clamp_max` parameter from 2.5 to 3.1. This provides more headroom f
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    for c in range(NUM_CLASSES):
        clamp_max = 3.1 if c == 3 else 2.5
        pred[:, :, c] *= np.clip(ratio[c], 0.1, clamp_max)
