# Score: avg=82.15
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.08 to compensate for coastal under
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Increase the global multiplier for the port class (class 2) to 1.08
    ratio[2] *= 1.08
