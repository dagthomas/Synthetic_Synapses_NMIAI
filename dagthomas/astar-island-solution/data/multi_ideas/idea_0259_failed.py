# FAILED: Crashed on round2 seed 0: name '_build' is not defined
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.45 to better capture h
