# Score: avg=86.40
# Direction: Try **increasing the forest calibration weight** (e.g., coarse_max for forest from 1.5 to 2.0) — t
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    # Boost forest calibration weight: amplify forest confidence in coarse priors
    # Equivalent to raising coarse_max for forest from ~1.5 to ~2.0 (factor 1.33)
    # Reduces settlement overprediction on forested cells by strengthening forest prior
    priors[:, 4] *= (2.0 / 1.5)
