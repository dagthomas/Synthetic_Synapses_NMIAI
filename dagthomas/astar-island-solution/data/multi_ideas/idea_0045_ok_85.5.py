# Score: avg=85.54
# Direction: Increase the settlement class calibration weight for the coarse_max level from 2.0 to 2.35 to better
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    if is_sett.any():
        ...
        if obs_expansion_radius is not None:
            ...
            pred[out_of_bounds, 2] *= 0.01
            pred[out_of_bounds, 3] *= 0.01
