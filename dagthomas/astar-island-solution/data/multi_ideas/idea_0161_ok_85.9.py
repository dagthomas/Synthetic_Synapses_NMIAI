# Score: avg=85.93
# Direction: Increase the `port` class global multiplier from 1.0 to 1.08 to address the underprediction on coast
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[2] = np.power(ratio[2], bp) * 1.08
