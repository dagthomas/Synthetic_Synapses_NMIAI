# FAILED: Crashed on round2 seed 0: name 'build_feature' is not defined
# Direction: Adjust the `settlement` class probability clamp range from [0.15, 2.5] to [0.10, 2.80] to better acc
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    try:
        ...
        p = {"prior_w": 2.0, "emp_max": 5.0, "ratio_min": 0.5, "ratio_max": 2.0}
