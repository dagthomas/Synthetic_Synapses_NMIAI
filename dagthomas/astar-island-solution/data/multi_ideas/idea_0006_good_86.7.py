# Score: avg=86.68
# Direction: Tighten the settlement clamp range slightly (e.g., `[0.15, 2.5]` → `[0.18, 2.3]`) to reduce extrem
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 2.2,
    ...
    for i in range(N):
        ...
        mults[1] = np.clip(mults[1], 0.18, 2.3)
