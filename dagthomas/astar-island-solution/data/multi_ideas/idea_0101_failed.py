...
# Direction: Increase the `settlement` class clamp range from [0.15, 2.5] to [0.12, 2.80] to prevent probability 
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = globals().get('_load_params', lambda: {"prior_w": 2.0, "emp_max": 5.0})()
