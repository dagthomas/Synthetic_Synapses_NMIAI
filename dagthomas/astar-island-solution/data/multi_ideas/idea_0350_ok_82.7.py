# Score: avg=82.73
# Direction: Increase the `coarse_max` calibration weight from 3.0 to 4.0 to further prioritize high-confidence f
# Error: None
...
def experimental_pred_fn(state: dict, global_mult,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 4.0,
