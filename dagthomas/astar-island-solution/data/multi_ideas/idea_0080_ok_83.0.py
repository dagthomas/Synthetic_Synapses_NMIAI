# Score: avg=82.96
# Direction: Increase the global multiplier for the `port` class from 1.0 to 1.15 to mitigate coastal underpredic
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    t_classes = np.array([[terrain_to_class(grid[r, c]) for c in range(MAP_W)] for r in range(MAP_H)])
    mountain_mask = (t_classes == 5)
