# FAILED: Compilation failed: expected ':' (<string>, line 30)
# Direction: Increase the `coarse_max` calibration weight for the `settlement` class from 1.0 to 1.12 to improve 
