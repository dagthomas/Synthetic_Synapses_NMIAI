# Score: avg=76.32
# Direction: Increase the `settlement` class `clamp_min` from 0.15 to 0.22 to reduce the entropy-weighted KL dive
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    pred[:, :, :5] = np.where(mountain_mask[:, :, np.newaxis], 0.0, pred[:, :, :5])
