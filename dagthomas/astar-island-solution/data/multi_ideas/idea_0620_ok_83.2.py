# Score: avg=83.23
# Direction: Increase the `settlement` class `clamp_max` from 2.5 to 3.2 to allow for higher peak probability den
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_max = np.array([2.5, 2.5, 2.5, 3.2, 2.5, 2.5])
    ratio = np.clip(ratio, 0.0, clamp_max)
