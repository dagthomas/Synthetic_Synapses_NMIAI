# Score: avg=86.57
# Direction: Increase the global multiplier for the port class from 1.0 to 1.1 to address coastal underprediction
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    nonzero_mask = pred > 0
    pred[nonzero_mask] = np.maximum(pred[nonzero_mask], 0.005)
