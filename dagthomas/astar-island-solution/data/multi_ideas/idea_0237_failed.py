...
# Direction: Increase the `port` class `coarse_max` calibration weight from 2.0 to 2.2 to allow coastal feature-k
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    coarse_max_arr[2] = 2.2
    
    cal_params = {
        'cal_fine_base': 1.0, 'cal_fine_divisor': 100.0, 'cal_fine_max': 5.0,
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': coarse_max_arr,
