# FAILED: Compilation failed: '{' was never closed (<string>, line 34)
# Direction: Adjust the `settlement` class calibration weight for the coarse-grid level from 2.0 to 2.4 to increa
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        'cal_fine_base': 1.0, 'cal_fine_divisor': 100.0, 'cal_fine_max': 5.
    return probs