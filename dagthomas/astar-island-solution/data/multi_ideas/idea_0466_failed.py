# FAILED: Compilation failed: invalid syntax (<string>, line 77)
# Direction: Adjust the `settlement` class `clamp_min` from 0.01 to 0.015 to mitigate KL divergence penalties cau
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    valid_settlement = ~water_mask & ~mountain_mask
    probs[valid_settlement, 1] =
    return probs