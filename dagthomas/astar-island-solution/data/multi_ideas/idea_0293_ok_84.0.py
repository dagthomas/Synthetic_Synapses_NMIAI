# Score: avg=84.03
# Direction: Adjust the `settlement` class `clamp_range` from [0.15, 2.5] to [0.12, 2.90] to allow for higher pea
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    ratio[1] = np.clip(ratio[1], 0.12, 2.90)
    ...
    pred = np.where(row_sums > 0, pred / row_sums, 1.0 / NUM_CLASSES)
