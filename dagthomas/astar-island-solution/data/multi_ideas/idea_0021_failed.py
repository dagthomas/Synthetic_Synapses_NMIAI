# FAILED: Compilation failed: '(' was never closed (<string>, line 53)
# Direction: Decrease the settlement class clamp lower bound from 0.15 to 0.12 to allow for better calibration of
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = globals().get('_load_params', lambda: {"prior_w": 1.0, "emp_max": 2.0, "base_power": 0.5})()
