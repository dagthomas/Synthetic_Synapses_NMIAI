# FAILED: Compilation failed: '[' was never closed (<string>, line 70)
# Direction: Increase the `settlement` class `global_multiplier` from 1.0 to 1.04 to conservatively address its 4
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    """
    p = {"prior_w": 1.0, "emp_max": 5.0, "smooth_w": 0.1}
    ...
    blended = pred * prior_w + emp_grid * strengths[:, :,
    return probs