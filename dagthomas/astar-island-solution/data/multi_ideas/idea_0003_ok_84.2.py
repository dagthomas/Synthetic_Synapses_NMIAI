# Score: avg=84.17
# Direction: Increase the settlement smoothing kernel from 3 to 5 — this should reduce sharp settlement localiz
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    port_prior_boost = 1.25
    port_mult = port_prior_boost * (1.0 + 1.5 * np.exp(-0.2 * dist_to_coast))
    port_mult[~coastal_mask] = 1.0
