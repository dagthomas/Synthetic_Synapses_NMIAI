...
# Direction: Increase the `port` class global multiplier from 1.0 to 1.15 to address the reported underprediction
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    if hasattr(predict, '_load_params'):
        ...
        p = {"prior_w": 1.0, "emp_max": 3.0, "ratio_w": 0.5, "smooth_sigma": 0.5}
