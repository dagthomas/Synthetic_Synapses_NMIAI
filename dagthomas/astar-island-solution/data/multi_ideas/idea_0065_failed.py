# FAILED: Crashed on round2 seed 0: name 'blended' is not defined
# Direction: Increase the `settlement` class calibration weight `coarse_max` from 2.0 to 2.15 to better weight th
