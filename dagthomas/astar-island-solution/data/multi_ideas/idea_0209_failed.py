...
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.1. This provides a con
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    if obs_expansion_radius is not None and len(settlements) > 0:
        ...
        suppress = dist > obs_expansion_radius
        pred[suppress, 1] = 0.0
