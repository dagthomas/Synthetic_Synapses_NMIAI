...
# Direction: Increase the `port` class `coarse_max` calibration weight from 2.0 to 2.2 to address underprediction
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_coarse_max = np.array([2.0, 2.0, 2.2, 2.0, 2.0, 2.0])
    cal_params = {
