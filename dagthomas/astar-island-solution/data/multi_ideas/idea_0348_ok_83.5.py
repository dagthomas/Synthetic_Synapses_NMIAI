# Score: avg=83.55
# Direction: Increase the `port` class `global_multiplier` from 1.0 to 1.15 to address the coastal underpredictio
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Increase port class global_multiplier from 1.0 to 1.15
    ratio[2] *= 1.15
