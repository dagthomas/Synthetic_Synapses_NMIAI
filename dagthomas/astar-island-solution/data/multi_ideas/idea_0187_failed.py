# FAILED: Compilation failed: invalid decimal literal (<string>, line 64)
# Direction: Increase the `settlement` class `coarse_max` calibration weight from 2.0 to 2.4. This adjustment add
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    try:
        ...
        p = {"prior_w": 1.0, "emp_max": 3.0, "smooth_size": 3}
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 2.4,
    ...
    blended /= np.maximum(blended.sum(axis=-1, keepdims=True), 1e
    return probs