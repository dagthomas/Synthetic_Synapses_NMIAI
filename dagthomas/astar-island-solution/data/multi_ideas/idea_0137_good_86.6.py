# Score: avg=86.57
# Direction: Increase the settlement class upper clamp from 2.5 to 2.8 to better accommodate high-density settlem
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[1] = np.clip(mult[1], 0.15, 2.8)
    ...
    if is_sett.any():
        ...
        if obs_expansion_radius is not None:
            suppress = dist_map > obs_expansion_radius
            pred[suppress, 1] *= 0.1
            pred[suppress, 2] *= 0.1
