# Score: avg=83.76
# Direction: Adjust the `settlement` class clamp range from [0.15, 2.5] to [0.10, 2.8] to allow the Bayesian prio
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    ratio[1] = np.clip(ratio[1], 0.10, 2.8)
    ...
    probs = np.where(probs > 0, np.maximum(probs, 0.005), 0)
