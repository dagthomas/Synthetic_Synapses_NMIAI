# FAILED: Compilation failed: '(' was never closed (<string>, line 76)
# Direction: Increase the `settlement` class upper probability clamp from 2.5 to 2.7 to better accommodate high-d
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Settlement class upper probability clamp increased from 2.5 to 2.7
    ratio[1] = np.minimum(ratio[1], 2.7)
    ...
    blended /= np.maximum(blended.sum(axis=-1, keep
    return probs