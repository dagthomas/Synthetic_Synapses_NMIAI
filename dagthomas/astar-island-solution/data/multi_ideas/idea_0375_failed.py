# FAILED: Crashed on round2 seed 0: name 'prior__' is not defined
# Direction: Increase the `settlement` class `global_multiplier` from 1.0 to 1.05 to conservatively address the d
