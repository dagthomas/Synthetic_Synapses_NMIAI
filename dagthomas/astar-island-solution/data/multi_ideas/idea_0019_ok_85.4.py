# Score: avg=85.35
# Direction: Adjust the settlement class probability clamp from [0.15, 2.5] to [0.12, 2.8] to allow for higher pe
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    pred[:, :, 1] = np.clip(pred[:, :, 1], 0.12 * raw_priors[idx_grid][:, :, 1], 2.8 * raw_priors[idx_grid][:, :, 1])
