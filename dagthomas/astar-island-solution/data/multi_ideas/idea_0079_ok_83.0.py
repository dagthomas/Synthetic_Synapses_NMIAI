# Score: avg=83.01
# Direction: Adjust the `settlement` class clamp range from [0.15, 2.5] to [0.12, 2.8] to allow for more nuanced 
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    # Adjust settlement class clamp range
    ratio[1] = np.clip(ratio[1], 0.12, 2.8)
    ...
    # Fallback to ensure all rows sum to 1.0
