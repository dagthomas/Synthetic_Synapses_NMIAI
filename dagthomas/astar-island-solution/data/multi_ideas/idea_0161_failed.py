# FAILED: Crashed on round2 seed 0: name 'ratio' is not defined
# Direction: Adjust the `settlement` class `coarse_max` calibration weight from 2.0 to 1.75 to reduce over-concen
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    cal_params = {
        ...
        'cal_coarse_base': 0.5, 'cal_coarse_divisor': 100.0, 'cal_coarse_max': 1.75,
