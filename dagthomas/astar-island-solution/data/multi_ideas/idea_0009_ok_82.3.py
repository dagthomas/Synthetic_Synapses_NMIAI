# Score: avg=82.30
# Direction: Increase the settlement **smoothing kernel size from 3 to 5** — port errors are secondary, so rath
# Error: None
...
def experimental_pred_fn(state, global_mult, fk_buckets):
    ...
    port_mult = port_prior_boost * (1.0 + 1.5 * np.exp(-0.25 * dist_to_coast))
