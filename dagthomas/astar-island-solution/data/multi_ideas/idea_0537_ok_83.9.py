# Score: avg=83.90
# Direction: Adjust the `settlement` class `clamp_max` from 2.5 to 2.2 to reduce over-prediction in high-density 
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    clamp_max = np.array([5.0, 2.2, 5.0, 5.0, 5.0, 5.0])
    ratio = np.clip(ratio, 0.1, clamp_max)
