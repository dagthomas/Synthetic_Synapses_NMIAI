# Score: avg=86.12
# Direction: Decrease the settlement class lower clamp from 0.15 to 0.12 to reduce the aggressive suppression of 
# Error: None
...
def experimental_pred_fn(state: dict, global_mult: GlobalMultipliers,
    ...
    mult[1] = np.clip(mult[1], 0.12, 2.0)
    mult[2] = np.clip(mult[2], 0.12, 2.0)
    mult[3] = np.clip(mult[3], 0.12, 2.0)
