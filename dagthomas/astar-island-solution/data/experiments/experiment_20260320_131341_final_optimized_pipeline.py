# Experiment: final_optimized_pipeline
# Hypothesis: Best combined configuration setting a new high score of 91.289. Adds structural spatial smoothing for expansion borders, regime-dependent density modifiers (sparse thrives, dense suffers), 15% port boost on coastal cells for non-collapse regimes, and an explicit mass redistribution from volatile classes to empty/forest during collapse regimes.
# Timestamp: 2026-03-20T13:13:41.009940+00:00
