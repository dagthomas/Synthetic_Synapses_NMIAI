# Experiment: reduced_floor_and_dynamic_radius
# Hypothesis: Reduced probability floor from 0.005 to 1e-5 to stop wasting 2% map mass per cell + Dynamic radius for temperature softening based on the regime.
# Timestamp: 2026-03-20T10:36:11.413839+00:00
...
def experimental_pred_fn(state: dict, global_mult, fk_buckets) -> np.ndarray:
    ...
    # Radius adapts to regime: survival/expansion ratio
    ...
    # 7. Floor nonzero classes: reduced from 0.005 to 1e-5
