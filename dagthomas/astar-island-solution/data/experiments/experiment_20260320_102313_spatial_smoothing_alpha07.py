# Experiment: spatial_smoothing_alpha07
# Hypothesis: Spatial smoothing on volatile classes (settlement, port, ruin) offsets spatial uncertainty penalties.
# Timestamp: 2026-03-20T10:23:13.419033+00:00
...
def experimental_pred_fn(state: dict, global_mult, fk_buckets) -> np.ndarray:
    ...
    # Applies a 3x3 spatial smoothing to volatile classes to hedge against spatial location uncertainty 
    # (e.g. settlements expanding 1 block off prediction). Alpha=0.7 is the blend factor keeping 70% original.
    alpha = 0.7
    for k in [1, 2, 3]:  # settlement, port, ruin
