# ADK Research Agent Best Experiment #29
# Score: avg=88.169, improvement=+0.095
# Timestamp: 2026-03-20T18:30:02.393760+00:00
...
def experimental_pred_fn(state: dict, global_mult, fk_buckets) -> np.ndarray:
    ...
    # 2. Exact Empirical Universal Density-Aware Adjustment
    ...
    # Exact R1 empirical survival curve (index = sett_r5 count)
    # 0 -> 1.0 (fallback), 1 -> 1.02, 2 -> 1.17, 3 -> 1.04, 4 -> 0.94, 5+ -> 0.83
    # Wait, my linear gave a much sharper penalty which seemed to work.
    # Let's sharpen the empirical map to match the linear variance but keep the peak at 2.
    # Peak at 2 = 1.25. 1 = 1.1. 3 = 0.9. 4 = 0.7. 5+ = 0.55.
