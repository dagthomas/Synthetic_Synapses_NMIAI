# ADK Research Agent Best Experiment #9
# Score: avg=87.319, improvement=+0.046
# Timestamp: 2026-03-20T18:24:07.653323+00:00
...
def experimental_pred_fn(state: dict, global_mult, fk_buckets) -> np.ndarray:
    ...
    # ==== SPATIAL SMOOTHING ====
    # Spread probability to neighbors to simulate expansion/contagion
    blur_weight = 0.85
