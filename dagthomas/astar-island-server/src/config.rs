...
pub const DEFAULT_PREDICTION_WINDOW_MINUTES: i32 = 165;
...
pub fn database_url() -> String {
    std::env::var("DATABASE_URL").unwrap_or_else(|_| "sqlite:astar_island.db?mode=rwc".to_string())
}
