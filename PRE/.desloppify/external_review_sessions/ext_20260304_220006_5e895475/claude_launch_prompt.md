...
Template JSON: X:\KODE\AINM\PRE\.desloppify\external_review_sessions\ext_20260304_220006_5e895475\review_result.template.json
Output JSON path: X:\KODE\AINM\PRE\.desloppify\external_review_sessions\ext_20260304_220006_5e895475\review_result.json
...
3. Keep `session.id` exactly `ext_20260304_220006_5e895475`.
4. Keep `session.token` exactly `bbc06c5304dd2498431bfd744c2c9318`.
